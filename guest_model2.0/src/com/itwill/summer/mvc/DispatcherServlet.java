...
public class DispatcherServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		String siteRootRealPath = this.getServletContext().getRealPath("/");//C:\2022-11-JAVA-DEVELOPER\workspaceEE\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\guest_model2.0\
		...
		try {
			...
			/*
			 ...
			 --------------------------------------------	
			*/
			Set commandKeySet=controllerMappingProperties.keySet(); // /guest_write_action.do
			
			
			Iterator<String> commandKeyIterator=  commandKeySet.iterator(); //java.util.Hashtable$Enumerator@56f694c7
			
			while (commandKeyIterator.hasNext()) {
				String command = commandKeyIterator.next();///guest_view.do
				String controllerClassName = controllerMappingProperties.getProperty(command); //com.itwill.guest.controller.GuestViewController
				 ...
				 */
				Class controllerClass=Class.forName(controllerClassName); //class com.itwill.guest.controller.GuestWriteActionController
				Controller controllerObject=(Controller)controllerClass.newInstance();//com.itwill.guest.controller.GuestWriteActionController@355e60a8
				handlerMapping.put(command, controllerObject);// System.out.println(command+"-"+controllerObject); /guest_list.do-com.itwill.guest.controller.GuestListController@63214b52
