...
<body bgcolor=#FFFFFF text=#000000 leftmargin=0 topmargin=0
	...
	<div id="container">
		<!-- header start -->
		<div id="header">
			<!-- include_common_top.do start-->
			<jsp:include page="include_common_top.jsp"/>
			<!-- include_common_top.do end-->
		</div>
		<!-- header end -->
		<!-- navigation start-->
		<div id="navigation">
			<!-- include_common_left.do start-->
			<jsp:include page="include_common_left.jsp"/>
			<!-- include_common_left.do end-->
		</div>
		<!-- navigation end-->
		<!-- wrapper start -->
		<div id="wrapper">
			<!-- content start -->
			<!-- include_content.do start-->
			...
			<!-- include_content.do end-->
			<!-- content end -->
		</div>
		<!--wrapper end-->
		<div id="footer">
			<!-- include_common_bottom.do start-->
			<jsp:include page="include_common_bottom.jsp"/>
			<!-- include_common_bottom.do end-->
		</div>
	</div>
	<!--container end-->
</body>
